...
angular.module('nzbhydraApp').config(["$stateProvider", "$urlRouterProvider", "$locationProvider", "blockUIConfig", "$urlMatcherFactoryProvider", function ($stateProvider, $urlRouterProvider, $locationProvider, blockUIConfig, $urlMatcherFactoryProvider) {
    ...
    $stateProvider
        ...
        .state("config", {
            url: "/config",
            templateUrl: "static/html/states/config.1731526a.html",
...
function otherColumns($http, $templateCache, $compile, $window) {
    ...
    return {
        ...
        link: function (scope, element, attrs) {
            $http.get('static/html/directives/search-result-non-title-columns.42f10fb8.html', {cache: $templateCache}).success(function (templateContent) {
...
function searchHistory() {
    return {
        templateUrl: 'static/html/directives/search-history.9006e70a.html',
...
function downloadHistory() {
    return {
        templateUrl: 'static/html/directives/download-history.e0ea32bf.html',
        controller: ['$scope', '$http', controller],
        scope: {}
    };
...
function cfgFormEntry() {
    return {
        templateUrl: 'static/html/directives/cfg-form-entry.d8891011.html',
        require: ["^title", "^cfg"],
        scope: {
            title: "@",
            cfg: "=",
...
function ConfigService($http, $q, $cacheFactory) {
    ...
    var cache = $cacheFactory("nzbhydra.3f0c13d8");
...
ConfigController.$inject = ["$scope", "ConfigService", "config", "CategoriesService", "ConfigFields", "ConfigModel", "ModalService", "RestartService", "$state", "formlyValidationMessages"];
...
//# sourceMappingURL=nzbhydra.js.0331fdc9.map
