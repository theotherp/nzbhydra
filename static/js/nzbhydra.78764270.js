...
angular.module('nzbhydraApp').config(["$stateProvider", "$urlRouterProvider", "$locationProvider", "blockUIConfig", "$urlMatcherFactoryProvider", function ($stateProvider, $urlRouterProvider, $locationProvider, blockUIConfig, $urlMatcherFactoryProvider) {
    ...
    $stateProvider
        ...
        .state("config", {
            url: "/config",
            templateUrl: "static/html/states/config.c46b4529.html",
        ...
        .state("about", {
            url: "/about",
            templateUrl: "static/html/states/about.4350194f.html",
...
function UpdateService($http, $sce, growl, blockUI, RestartService) {
    ...
    function showChanges() {
        ...
        var params = {
            size: "lg",
            templateUrl: "static/html/changelog.dda87e2e.html",
            resolve: {
                changelog: function () {
                    return changelog;
                }
...
function ConfigService($http, $q, $cacheFactory) {
    ...
    var cache = $cacheFactory("nzbhydra.78764270");
...
//# sourceMappingURL=nzbhydra.js.0241e83a.map
