...
class MyTestCase(unittest.TestCase):
    ...
    def testFindDuplicates(self):
        ...
        result1 = NzbSearchResult(title="Title1", epoch=0, size=1, provider="1a", guid="1", pubdate_utc=arrow.get(0).format('YYYY-MM-DD HH:mm:ss ZZ'))
        result2 = NzbSearchResult(title="Title1", epoch=10000000, size=1, provider="2a", guid="2", pubdate_utc=arrow.get(10000000).format('YYYY-MM-DD HH:mm:ss ZZ'))
        result3 = NzbSearchResult(title="Title1", epoch=0, size=1, provider="1b", guid="3", pubdate_utc=arrow.get(10000000).format('YYYY-MM-DD HH:mm:ss ZZ'))
        result4 = NzbSearchResult(title="Title1", epoch=10000000, size=1, provider="2b", guid="4", pubdate_utc=arrow.get(10000000).format('YYYY-MM-DD HH:mm:ss ZZ'))
        result5 = NzbSearchResult(title="Title1", epoch=1000000000, size=1, provider="3", guid="5", pubdate_utc=arrow.get(1000000000).format('YYYY-MM-DD HH:mm:ss ZZ'))
        ...
        result1 = NzbSearchResult(title="Title1", epoch=0, size=1, provider="1", guid="1")
        result2 = NzbSearchResult(title="Title1", epoch=30 * 1000 * 60, size=1, provider="2", guid="2")
        result3 = NzbSearchResult(title="Title1", epoch=60 * 1000 * 60, size=1, provider="2", guid="3")
        ...
        result3 = NzbSearchResult(title="Title3", epoch=5000000, size=1, provider="2", guid="3")
        results = api.find_duplicates([result1, result2, result3])
        self.assertEqual(3, len(results))
        self.assertEqual(1, len(results[0]))
        self.assertEqual(1, len(results[1]))
        ...
        result1 = NzbSearchResult(title="Title1", epoch=0, size=1, provider="1", guid="1")
        result2 = NzbSearchResult(title="Title2", epoch=0, size=1, provider="2", guid="2")
        result3 = NzbSearchResult(title="Title3", epoch=0, size=1, provider="2", guid="3")
        results = api.find_duplicates([result1, result2, result3])
        self.assertEqual(3, len(results))
        self.assertEqual(1, len(results[0]))
        self.assertEqual(1, len(results[1]))
        ...
        result1 = NzbSearchResult(title="Title1", epoch=0, size=1, provider="1", guid="1", poster="postera", group="groupa")
        result2 = NzbSearchResult(title="Title1", epoch=1000 * 60 * 23, size=1, provider="2", guid="2", poster="postera", group="groupa")
        results = api.find_duplicates([result1, result2])
        self.assertEqual(1, len(results))
        self.assertEqual(2, len(results[0]))
        ...
        result1 = NzbSearchResult(title="Title1", epoch=0, size=1, provider="1", guid="1", poster="postera", group="groupa")
        result2 = NzbSearchResult(title="Title1", epoch=1000 * 60 * 25, size=1, provider="2", guid="2", poster="postera", group="groupa")
        results = api.find_duplicates([result1, result2])
        self.assertEqual(2, len(results))

        # Same size and age and group but different posters (very unlikely) 
        result1 = NzbSearchResult(title="Title1", epoch=0, size=1, provider="1", guid="1", poster="postera", group="groupa")
        result2 = NzbSearchResult(title="Title1", epoch=0, size=1, provider="2", guid="2", poster="posterb", group="groupa")
        results = api.find_duplicates([result1, result2])
        self.assertEqual(2, len(results))

        # Same size and age and poster but different groups (very unlikely) 
        result1 = NzbSearchResult(title="Title1", epoch=0, size=1, provider="1", guid="1", poster="postera", group="groupa")
        result2 = NzbSearchResult(title="Title1", epoch=0, size=1, provider="2", guid="2", poster="postera", group="groupb")
        results = api.find_duplicates([result1, result2])
        self.assertEqual(2, len(results))

        # Same size and age and poster but unknown group inside of 12 hours 
        result1 = NzbSearchResult(title="Title1", epoch=0, size=1, provider="1", guid="1", poster="postera")
        result2 = NzbSearchResult(title="Title1", epoch=1000 * 60 * 11, size=1, provider="2", guid="2", poster="postera", group="groupb")
        results = api.find_duplicates([result1, result2])
        self.assertEqual(1, len(results))

        # Same size and age and poster but unknown group outside of 12 hours 
        result1 = NzbSearchResult(title="Title1", epoch=0, size=1, provider="1", guid="1", poster="postera")
        result2 = NzbSearchResult(title="Title1", epoch=1000 * 60 * 13, size=1, provider="2", guid="2", poster="postera", group="groupb")
        results = api.find_duplicates([result1, result2])
        self.assertEqual(2, len(results))
        
    def testFindDuplicatesNew(self):
        result1 = NzbSearchResult(title="Title1", epoch=0, size=1, provider="1", guid="1", poster="postera", group="groupa")
        result2 = NzbSearchResult(title="Title1", epoch=0, size=2, provider="2", guid="2", poster="postera", group="groupb")
        result3 = NzbSearchResult(title="Title1", epoch=0, size=3, provider="3", guid="3", poster="postera", group="groupb")
        results = api.find_duplicates([result1, result2, result3])
        self.assertEqual(3, len(results))
